...
# gmodel.py reads the rough/raw data from content.sqlite and produces 
...
# Open the main content (Read only) to potentially run this and spider at the same time
